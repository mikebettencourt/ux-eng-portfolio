    ...
    return (
      <>
        ...
        <section className="exam-tracking-container">
          ...
          <section className="content-section">
            <h5 className="content-label">Collaborators</h5>
            <ul className="content-copy">
              <li>Product Owner</li>
          ...
          <section className="content-section">
            <h5 className="content-label">Problem</h5>
            <p className="content-copy">
          ...
          <section className="content-section">
            <h5 className="content-label">Process</h5>
            <p className="content-copy">
            <p><i>Discovery</i></p>
          ...
          <section className="content-section">
            <h5 className="content-label">Challenges</h5>
            <p className="content-copy">
