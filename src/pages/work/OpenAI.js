function OpenAI() {
    return (
        <section className="responsive-design-container">
            <h1 className="content-header">OpenAI Landing Page</h1>
            <section className="content-section">
                <h5 className="content-label">Skills</h5>
            ...
            <section className="content-section">
                ...
                <div className="content-copy-wrapper">
                    ...
                    <br />
                    <br />
                    <a href="https://main.d3n754az0suscd.amplifyapp.com/" target="_blank" rel="noreferrer">Live site</a>
                    </p>
                </div>
            </section>
        </section>
